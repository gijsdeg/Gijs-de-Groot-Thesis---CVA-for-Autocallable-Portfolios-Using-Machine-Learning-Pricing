...
This repository contains most parts of my thesis code. The main parts are the market simulation, cva framework and machine learning models used for pricing the autocallables. Here is a short description of each file.
...
- `cva_ml.py` - Similar to `cva.py` but it does not call the matlab pricing engine but uses trained machine learning models instead.
...
- `neuralnet.ipynb` - Notebook used to train neural network.
